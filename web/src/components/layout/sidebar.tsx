        ...
        >
            ...
            <div className="mt-auto py-4 border-none">
                ...
                <div className="text-center text-xs text-white/60 dark:text-white mt-4 px-4 flex items-center justify-center gap-1">
                    ...
                    <span>by</span>
                    <a href="https://github.com/HUAHUAI23/RuiQi" target="_blank" rel="noopener noreferrer" className="text-white/60 dark:text-white dark:text-shadow-glow-white">Hedun WAF team</a>
                </div>
            </div>
        </div >
    )
